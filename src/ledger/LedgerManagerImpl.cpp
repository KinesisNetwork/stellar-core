...
const uint32_t LedgerManager::GENESIS_LEDGER_BASE_FEE = 500;
const uint32_t LedgerManager::GENESIS_LEDGER_BASE_RESERVE = 500000000;
const uint32_t LedgerManager::GENESIS_LEDGER_MAX_TX_SIZE = 100;
const int64_t LedgerManager::GENESIS_LEDGER_TOTAL_COINS = 5000000000000000000;
